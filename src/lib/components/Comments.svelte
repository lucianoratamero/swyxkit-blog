<script>
	/** @type {import('$lib/types.js').GHMetadata} */
...
<a
	...
	rel="external"
	target="_blank"
	class="flex justify-center border-y border-blue-700 p-4 no-underline hover:text-cyan-700 dark:hover:text-cyan-200 sm:inline sm:rounded-xl sm:border-x"
>
	Leave a new comment!
</a>
